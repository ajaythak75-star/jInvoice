          ...
          return (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {/* Line 2: source chip + doctype/category/status chips + amount */}
                ...
                {/* Line 3: Subject + Folder */}
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 2, ...metaStyle }}>
                  <span style={{ flex: 1, minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                    <span style={labelStyle}>Subject</span>{rec.subject ?? "—"}
                  </span>
                  <span style={{ flexShrink: 0 }}>
                    <span style={labelStyle}>Folder</span>{formatSource(rec.importSource)}
                  </span>
                </div>
                {/* Line 4: Sender + Received date */}
